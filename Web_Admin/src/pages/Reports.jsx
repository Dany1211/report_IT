...
//           <div className="bg-white rounded-2xl shadow-xl p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto animate-fadeIn border border-[#FFE4B5]">
...
//             {message && (
//               <p className="mt-3 text-sm text-center text-[#333333]">{message}</p>
//             )}
...
//   // Fetch reports + images (user + admin)
//   useEffect(() => {
//     const fetchReports = async () => {
//       const { data, error } = await supabase
//         .from("reports")
...
//         (searchQuery === "" ||
//           report.location?.toLowerCase().includes(searchQuery.toLowerCase())) &&
//         (dateFilter === "" || reportDate >= filterDate)
//       );
//     })
//     .sort((a, b) => {
...
//     if (["In Progress", "Resolved"].includes(selectedReport.status) && !selectedDept) {
...
//     setSelectedReport({ ...report, sequenceId: index + 1 });
//     setSelectedDept(report.assigned_to_dept || "");
//   };
